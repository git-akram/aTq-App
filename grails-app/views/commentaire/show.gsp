	...
	<body>
		...
		<div id="show-commentaire" class="content scaffold-show" role="main">
			...
			<ol class="property-list commentaire">
				...
				<g:if test="${commentaireInstance?.intitule}">
				<li class="fieldcontain">
					<span id="intitule-label" class="property-label"><g:message code="commentaire.intitule.label" default="Intitule" /></span>
					
						<span class="property-value" aria-labelledby="intitule-label"><g:fieldValue bean="${commentaireInstance}" field="intitule"/></span>

...
<html>
	...
	<body>
		<a href="#edit-departement" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-departement" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${departementInstance?.version}" />
				<fieldset class="form">
